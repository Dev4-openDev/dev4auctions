...
<div class="center">
	...
	<br/>
		...
		<p>Hartelijk bedankt voor uw interesse.<br/> U heeft het hoogste bod geplaatst tegen een bedrag van  € {$price_new} voor product {$auction_link} <br/>Indien er een hoger bod geplaatst wordt krijgt u hier een melding van en indien u geen melding krijgt bent u dan hoogstwaarschijnlijk “de winnaar”.</p>
		<br/>
	</div>
</div>
<div class="footer">
